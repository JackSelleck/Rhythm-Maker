...
public class ClickGreenNotes : MonoBehaviour /// Detects Collisions for the note clicking and does the click anim
{
    public DetectPeaks DetectPeaks;
    public SetAudioDelay setAudioDelay;

    // For animating the button going up and down
    ...
    {
        if (Input.GetKeyDown(KeyCode.A) && Notes.Count > 0)
        {
