...
public class ClickPinkNotes : MonoBehaviour /// Detects Collisions for the note clicking and does the click anim
{
    ...
    private void HitPinkNotes()
    {
        if (Input.GetKeyDown(KeyCode.F) || (Input.GetKeyDown(KeyCode.K) && Notes.Count > 0))
        {
